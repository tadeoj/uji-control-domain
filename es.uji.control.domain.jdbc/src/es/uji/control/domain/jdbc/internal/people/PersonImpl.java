...
public class PersonImpl implements IPersonService {
	...
	public PersonImpl(Connection connection) throws PeopleDomainConnectionException {
		...
		try {
			...
			throw new PeopleDomainConnectionException("Imposible crear las sentencias JDBC", sqlEx);
		}
	}
